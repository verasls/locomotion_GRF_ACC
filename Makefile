...
manuscript/manuscript.pdf: manuscript/manuscript.Rmd manuscript/bibliography.bib manuscript/ama.csl manuscript/preamble.tex code/02_explore.R data/mechanical_load_data.rda figures/fig1.png figures/fig2.png figures/figS1.png figures/figS2.png figures/figS3.png figures/figS4.png tables/tab1.R tables/tab2.R code/funs.R output/prediction_models.rda
	Rscript -e 'rmarkdown::render("$<")'

manuscript/manuscript.docx: manuscript/manuscript.Rmd manuscript/bibliography.bib manuscript/ama.csl manuscript/preamble.tex manuscript/style_reference.docx code/02_explore.R data/mechanical_load_data.rda figures/fig1.png figures/fig2.png figures/figS1.png figures/figS2.png figures/figS3.png figures/figS4.png tables/tab1.R tables/tab2.R code/funs.R output/prediction_models.rda
	Rscript -e 'rmarkdown::render("$<", output_format = "word_document")'

## figures    : Generates all figures
figures: figures/fig1.tiff figures/fig2.tiff figures/figS1.tiff figures/figS2.tiff figures/figS3.tiff figures/figS4.tiff figures/fig1.png figures/fig2.png figures/figS1.png figures/figS2.png figures/figS3.png figures/figS4.png
