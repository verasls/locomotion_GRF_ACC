...
figures/scatterplot_GRF.tiff figures/scatterplot_LR.tiff: data/running_df.rda figures/scatterplot.R
...
output/loocv_data.rda: data/running_df.rda code/03_build_models.R
