...
Also, to simplify the use of these equations and enhance their applicability, a software package was developed for use in the R statistical software (REF). Included in this package are functionalities to read raw ACC data, process it and apply the equations to predict both pGRF and pLR. In the package website (LINK) there are also instructions on how to use it to obtain the predictions, namely in the 'Home' and 'Get started' sections.
