...
\begin{figure}[ht]
	...
	\end{measuredfigure}
\end{figure}
\footnotesize \textbf{Supplemental Figure S1.} Example of the ground reaction force and acceleration signals during the stance phase. Signals were mean centered and scaled to units of standard deviation to fit in the same plot window. In this image, the peak of each signal (star mark) represents the maximum impact between the foot and the ground. The circles mark the beginning of the curve, i.e., the start of the ascending phase of the signal that culminates in its peak. The region of the acceleration signal between the circle and the star marks was used to compute the acceleration rate, and the same region on the ground reaction force signal was used to compute the loading rate.
