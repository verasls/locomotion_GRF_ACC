...
Regression equations to predict pGFR and pLR for each accelerometer placement (ankle, lower back and hip) and vector (resultant and vertical) were developed by linear mixed models. Body mass (kg) was tested as a predictor in all models. In addition, in the pGRF models pACC was tested as predictor, while in the pLR models pAR was tested as predictor. All predictors were tested as fixed effects and were shown to be significant. Subject and speed were tested as random effects, and the inclusion of both has showed to improve the models. Final models were chosen according to -2 log-likelihood statistics [@Field2012]. Traditional coefficient of determination ($\mathrm{R^2}$) was represented by conditional $\mathrm{R^2}$, that estimates the variance explained by the whole model [@Nakagawa2013].
